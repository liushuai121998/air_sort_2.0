        ...
        //vm.$http.get('/api/data').then((res) => {
            ...
            nameArr.forEach((name) => {
              data.flight.forEach((item, index) => {
                ...
                if(item[name].indexOf('2017-') >= 0 && name != 'operationDate') {
                  item[name] = item[name].slice(11, 16)
            ...
            // let nameArr = Object.keys(state.initData[0])
            // nameArr.forEach((name) => {
            //   state.initData.forEach((item) => {
            //     if(name === 'operationDate') {
            //       item[name].slice(5, 10)
            //     }else if(item[name].indexOf('2017-') >=0 && name != 'operationDate') {
            //       item[name].slice(11, 16)
            //     }
            //   })
            // })
